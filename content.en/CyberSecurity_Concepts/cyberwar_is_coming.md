...
Marcus Hutchins discovered the hardcoded Kill Switch step of WannaCry. Then the spread of the worm is severely reduced. Several variants of the worm came with distributed attacks with the intention of spreading offline. Researches were carried out on the encryption process of WannaCry. The Windows Operating Systems were updated to get rid of unauthorized encryptions.
...
In 2007 the United states launched the Stuxnet worm to advert Iran’s nuclear program. This shows the power of network security breach, what if this attack was more malicious to attack another country without permission. This case shows the importance of security in army sector, as weapons are connected to the cyber world, the probability of any countries weapon system to become compromised has increased.
